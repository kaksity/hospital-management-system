// components/Modals/ChooseApplicationCategoryModal.tsx
"use client";
...
export default function ChooseApplicationCategoryModal({
  open,
  onOpenChange,
}: {
  open: boolean;
      ...
      <DialogContent className="max-w-lg max-h-[80vh] p-6">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Select the visa category for your new application.
          </p>
        </DialogHeader>
            ...
            <>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  {schema.description ||
                    "This visa type requires specific evidence and documentation to support your application."}
                </p>
                  ...
                  <div className="space-y-3">
                    ...
                    {Object.keys(schema.criteria).length > 3 && (
                      <p className="text-xs text-muted-foreground italic mt-2">
                        + {Object.keys(schema.criteria).length - 3} more requirements
                      </p>
                    )}
                  </div>
                </ScrollArea>
