...
const MOCK_TEMPLATES = [
  { id: "1", name: "Normal Chest X-Ray", category: "X-RAY", status: "Published", content: "<h3><strong>Findings:</strong></h3><p>The heart size and mediastinal contours are within normal limits. The lungs are clear without focal consolidation, effusion or pneumothorax.</p><h3><strong>Impression:</strong></h3><p>Normal chest radiograph.</p>" },
  { id: "2", name: "Brain MRI (Pre-Contrast)", category: "MRI", status: "Published", content: "<h3><strong>Technique:</strong></h3><p>Multiplanar multisequence MRI of the brain was performed without intravenous contrast.</p><h3><strong>Findings:</strong></h3><p>The brain parenchyma demonstrates normal signal intensity. No evidence of acute infarct or hemorrhage.</p><h3><strong>Impression:</strong></h3><p>Normal non-contrast MRI brain.</p>" },
];
  ...
  useEffect(() => {
    ...
    if (template) {
      setFormData({
        ...
        service: template.category === "X-RAY" ? "Chest X-Ray" : (template.category === "MRI" ? "MRI Brain (Plain)" : ""),
      ...
      setFormData({
        ...
        service: "Chest X-Ray",
        status: "Published",
        content: "<h3><strong>Findings:</strong></h3><p>The heart size and mediastinal contours are within normal limits. The lungs are clear without focal consolidation, effusion or pneumothorax.</p><h3><strong>Impression:</strong></h3><p>Normal chest radiograph.</p>",
      });
    }
  }, [id]);
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-xl font-semibold text-slate-900">Edit Reporting Template</h1>
                </div>
                <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-widest mt-1">Modify the existing diagnostic protocol structure</p>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            {/* Template Identification */}
            <Card className="lg:col-span-1 border shadow-none bg-white rounded-xl">
            ...
            <Card className="lg:col-span-2 border shadow-none bg-white rounded-xl min-h-[600px] flex flex-col overflow-hidden">
              <CardHeader className="border-b bg-slate-50/50 py-4 space-y-0">
                ...
                <div className="text-[13px] font-medium text-slate-500">Modify the boilerplate content for this diagnostic protocol.</div>
              </CardHeader>
