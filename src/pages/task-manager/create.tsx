  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-[11px] font-bold text-slate-500 uppercase tracking-widest">Select a patient and create a reporting task for Doctors</p>
      </div>
      ...
      <div className="relative space-y-0">
          ...
          <div className="space-y-4">
            ...
            <PatientCollection
              ...
              emptyState={{
                ...
                description: "There are no patients in the system. Register a new patient to continue.",
                actionLabel: "Register New Patient",
                onActionClick: () => navigate("/patients/create")
              }}
        ...
        {/* Step 2: Task Details (only show if patient is selected) */}
        {formData.patientId && (
